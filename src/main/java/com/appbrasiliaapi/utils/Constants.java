package com.appbrasiliaapi.utils;

public class Constants {
    public static final String DELETE_SUCCESS = "Successful Delete";
    ...
    public static final String REGISTER_FAILED = "Failed Registration";
